...
public class FacultyCoreCourses extends Activity {  
	 ...
	 private CustomCursorAdapter customAdapter;
	    ...
	    public void onCreate(Bundle savedInstanceState) {
	        ...
	        setContentView(R.layout.activity_faculty_core_courses);
	        ...
	        new Handler().post(new Runnable() {
	            @Override
	            public void run() {
	                customAdapter = new CustomCursorAdapter(getApplicationContext(), databaseHelper.getAllData());
