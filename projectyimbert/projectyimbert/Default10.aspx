<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="Default10.aspx.cs" Inherits="Default10" %>
<script runat=server>
       ...
       
    {
        ...
        else if (!IsPostBack)
        {
            ...
            ds.SelectCommand = "select * from data where sub_category=" + p + " ";
        }
