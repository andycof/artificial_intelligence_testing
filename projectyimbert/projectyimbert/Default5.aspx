...
<script runat=server>
    ...
    {
        a = "select * from admin where admin_name='" + t1.Text + "' and pass_word='" + t2.Text + "'";
...
<br />
<br />
<asp:Label runat=server ID=Label3 CssClass=box13>Admin&nbsp;Name</asp:Label>
